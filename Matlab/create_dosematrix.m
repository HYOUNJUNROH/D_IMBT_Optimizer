...
workfolder = 'D:\___01_Works\IMBT\Development\2ProfLim_imbt\Patient_2';
strucf = [workfolder '\RS_patient2.dcm'];
planf= [workfolder '\RP_patient2.dcm'];
%dosef= [workfolder 'Patient_2\RD_patient4.dcm'];
imf= [workfolder '\MR'];


%strucf = 'D:\___01_Works\IMBT\Development\2ProfLim_imbt\2ProfLim\RS_patient4.dcm';
%planf= 'D:\___01_Works\IMBT\Development\2ProfLim_imbt\2ProfLim\RP_patient4.dcm';
%dosef= 'D:\___01_Works\IMBT\Development\2ProfLim_imbt\2ProfLim\RD_patient4.dcm';
%imf='D:\___01_Works\IMBT\Development\2ProfLim_imbt\2ProfLim\2ProfLim';
...
ss1new2= ss1*inv(rot_z)*inv(rot_y)*inv(rot_x)
...
cd(workfolder);
load('systemA_2nd.mat', 'A');
PTV=[]; tuning=[]; bladder=[]; rectum=[]; sigmoid=[]; bowel=[]; body=[];
[PTV, bladder, rectum, bowel, sigmoid, body, cnt, sum_tandem] = process_rotate_tandem_cpp(Xc, Yc, Zc, vC, source_pos, angle_pos, flag_body, ind_PTVd, ind_bladderd, ind_rectumd, ind_boweld, ind_sigmoidd, ind_bodyd, A);
